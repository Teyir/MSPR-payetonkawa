...
!function () {
    ...
    const s = "undefined" != typeof window ? window : Function("return this;")(), r = function (e, t, n) {
            const a = window.Prism;
            window.Prism = {manual: !0};
            var s = function (e) {
                var t = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i, n = 0, a = {}, s = {
                    ...
                    util: {
                        encode: function e(t) {
                            ...
                            e.className = e.className.replace(RegExp(t, "gi"), ""), e.classList.add("language-" + n), e.classList.add("line-numbers")
                    ...
                    highlightElement: function (t, n, a) {
                        ...
                        if (s.hooks.run("before-highlight", l), l.grammar) if (n && e.Worker) {
                            var c = new Worker(s.filename);
                            c.onmessage = function (e) {
                                u(e.data)
                            }, c.postMessage(JSON.stringify({language: l.language, code: l.code, immediateClose: !0}))
                        } else u(s.highlight(l.code, l.grammar, l.language)); else u(s.util.encode(l.code))
                    },
                ...
                function o(e, t, n, a, l, d) {
                    for (var g in n) if (n.hasOwnProperty(g) && n[g]) {
                        ...
                        for (var b = 0; b < p.length; ++b) {
                            ...
                            var h = p[b], f = h.inside, m = !!h.lookbehind, y = !!h.greedy, w = h.alias;
                            ...
                            for (var v = h.pattern || h, _ = a.next, x = l; _ !== t.tail && !(d && x >= d.reach); x += _.value.length, _ = _.next) {
                                ...
                                if (!(F instanceof r)) {
                                    ...
                                    if (y) {
                                        ...
                                        var $ = A.index, z = A.index + A[0].length, E = x;
                                    ...
                                    $ = A.index;
                                    var j = A[0], B = F.slice(0, $), T = F.slice($ + j.length), O = x + F.length;
                ...
                if (e.Prism = s, r.stringify = function e(t, n) {
                    ...
                    var n = JSON.parse(t.data), a = n.language, r = n.code, i = n.immediateClose;
            ...
            return s.languages.clike = {
            ...
            }), s.languages.insertBefore("c", "function", {constant: /\b(?:EOF|NULL|SEEK_CUR|SEEK_END|SEEK_SET|__DATE__|__FILE__|__LINE__|__TIMESTAMP__|__TIME__|__func__|stderr|stdin|stdout)\b/}), delete s.languages.c.boolean, function (e) {
                ...
                var u = l(r), c = RegExp(l(s + " " + r + " " + i + " " + o)), d = l(r + " " + i + " " + o),
                    g = l(s + " " + r + " " + o), p = a(/<(?:[^<>;=+\-*/%&|^]|<<self>>)*>/.source, 2),
                    b = a(/\((?:[^()]|<<self>>)*\)/.source, 2), h = /@?\b[A-Za-z_]\w*\b/.source,
                    f = t(/<<0>>(?:\s*<<1>>)?/.source, [h, p]), m = t(/(?!<<0>>)<<1>>(?:\s*\.\s*<<1>>)*/.source, [d, f]),
                    y = /\[\s*(?:,\s*)*\]/.source, w = t(/<<0>>(?:\s*(?:\?\s*)?<<1>>)*(?:\s*\?)?/.source, [m, y]),
                ...
                e.languages.csharp = e.languages.extend("clike", {
                    ...
                    "type-list": {
                        ...
                        inside: {
                            ...
                            }, keyword: c, "class-name": {pattern: RegExp(_), greedy: !0, inside: x}, punctuation: /[,()]/
                        }
                    },
                    preprocessor: {
                        pattern: /(^[\t ]*)#.*/m,
                ...
                var B = /:[^}\r\n]+/.source, T = a(t(/[^"'/()]|<<0>>|\(<<self>>*\)/.source, [z]), 2),
                    O = t(/\{(?!\{)(?:(?![}:])<<0>>)*<<1>>?\}/.source, [T, B]),
        ...
        }(), i = e => t => t.options.get(e), o = i("codesample_languages"), l = i("codesample_global_prismjs"),
        u = e => s.Prism && l(e) ? s.Prism : r,
        c = e => t(e) && "PRE" === e.nodeName && -1 !== e.className.indexOf("language-"), d = e => {
            ...
            const t = (e => o(e) || [
                ...
                {text: "C++", value: "cpp"},
                {text: "Shell", value: "sh"},
                {text: "Structured Text (IEC 61131-3)", value: "iecst"},
                {text: "YAML", value: "yaml"},
                {text: "Java", value: "java"}
            ])(e), s = (r = t, ((e, t) => 0 < e.length ? n.some(e[0]) : n.none())(r)).fold(("", () => ""), (e => e.value));
            var r;
            const i = ((e, t) => d(e).fold((() => t), (e => {
                const n = e.className.match(/language-(\w+)/);
                return n ? n[1] : t
            })))(e, s), l = (e => d(e).bind((e => n.from(e.textContent))).getOr(""))(e);
            e.windowManager.open({
                title: "Insert/Edit Code Sample",
                size: "large",
                body: {
                    type: "panel",
                    items: [{type: "selectbox", name: "language", label: "Language", items: t}, {
                        type: "textarea",
                        name: "code",
                        label: "Code view"
                    }]
                ...
                onSubmit: t => {
                    ...
                    ((e, t, n) => {
                        ...
                        e.undoManager.transact((() => {
                            const r = d(e);
                            return n = a.DOM.encode(n), r.fold((() => {
    ...
    e.add("codesample", (e => {
        (e => {
            ...
            t("codesample_languages", {processor: "object[]"}), t("codesample_global_prismjs", {
                processor: "boolean",
                default: !1
            })
        })(e), (e => {
            e.on("PreProcess", (t => {
                const n = e.dom, a = n.select("pre[contenteditable=false]", t.node);
                h.each(h.grep(a, c), (e => {
                    const t = e.textContent;
                    let a;
                    for (n.setAttrib(e, "class", p(n.getAttrib(e, "class"))), n.setAttrib(e, "contentEditable", null), n.setAttrib(e, "data-mce-highlighted", null); a = e.firstChild;) e.removeChild(a);
