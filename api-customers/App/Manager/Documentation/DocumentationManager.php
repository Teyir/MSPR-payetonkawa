...
class DocumentationManager extends AbstractManager
{
    ...
    private function getServiceControllers(string $serviceName): array
    {
        ...
        foreach ($controllers as $controller) {
            ...
            $namespace = 'Customers\\Controller\\' . $serviceName . "\\$controller";
    ...
    /**
     * @param String $class
     * @return \Customers\Manager\Documentation\DocumentationEntity[]
    ...
    /**
     * @param \Customers\Manager\Documentation\DocumentationEntity[] $data
     * @return void
     */
