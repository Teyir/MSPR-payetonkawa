...
class LangManager
{
     ...
     * @return bool
     * @desc We are checking if the $lang exist. If we don't pass parameter, we get the URL param with {@Orders\Manager\Lang\LangManager::getLang()} method.
     */
