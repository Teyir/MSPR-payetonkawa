...
use Orders\Manager\Router\Router;
use Orders\Utils\Tools;
use ReflectionClass;
...
class DocumentationManager extends AbstractManager
{
    ...
    private function getServiceControllers(string $serviceName): array
    {
        ...
        foreach ($controllers as $controller) {
            ...
            $namespace = 'Orders\\Controller\\' . $serviceName . "\\$controller";
    ...
    /**
     * @param String $class
     * @return \Orders\Manager\Documentation\DocumentationEntity[]
    ...
    /**
     * @param \Orders\Manager\Documentation\DocumentationEntity[] $data
     * @return void
     */
